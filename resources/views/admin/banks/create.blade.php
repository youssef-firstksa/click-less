        ...
        <div class="card-body">
            <div class="row gy-3">
                            ...
                            <div class="tab-pane fade {{ $loop->first ? ' show active ' : '' }}" id="{{$localeCode}}-inputs"
                                ...
                                <div class="row">
                                    <div class="col-12 mb-4">
                                        <x-admin.form.label
                                            for="title">{{__('admin.bank_management.form.title')}}</x-admin.form.label>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <x-admin.form.textarea name="{{ $localeCode }}[description]"
                                            id="description_{{ $localeCode }}"
                                            placeholder="{{__('admin.bank_management.form.description')}}"></x-admin.form.textarea>
                ...
                <div class="col-lg-6">
                    ...
                    <x-admin.form.input type="color" name="color" id="color"
                        placeholder="{{__('admin.bank_management.form.font_color')}}" />
                    <x-admin.form.error :messages="$errors->get('color')" />
                </div>
                ...
                <div class="col-lg-6">
                    ...
                    <x-admin.form.input type="file" name="logo" id="logo"
                        placeholder="{{__('admin.bank_management.form.logo')}}" />
                ...
                <div class="col-lg-6">
                    ...
                    <x-admin.form.input type="file" name="img" id="img"
                ...
                <div class="col-lg-6">
                    ...
                    <x-admin.form.select name="status" id="status">
                        ...
                        <option value="activated">{{__('admin.general.activated')}}</option>
                        <option value="disabled">{{__('admin.general.disabled')}}</option>
                    </x-admin.form.select>
                ...
                <div class="col-lg-6">
                    ...
                    <x-admin.form.input name="ai_key" id="ai_key"
                        placeholder="{{__('admin.bank_management.form.ai_key')}}" />
