<div class="row gy-3">
    <div class="col-lg-6">
        <x-form.label for="name">{{ __('dashboard.users_management.form.name') }}</x-dashboard.form.label>
    ...
    <div class="col-lg-6">
        <x-form.label for="email">{{ __('dashboard.users_management.form.email') }}</x-dashboard.form.label>
    ...
    <div class="col-lg-6">
        <x-form.label for="password">{{ __('dashboard.users_management.form.password') }}</x-dashboard.form.label>
    ...
    <div class="col-lg-6">
        <x-form.label for="role_id">{{ __('dashboard.users_management.form.role') }}</x-dashboard.form.label>
    ...
    <div class="col-lg-6">
        <x-form.label for="status">{{ __('dashboard.users_management.form.status') }}</x-dashboard.form.label>
