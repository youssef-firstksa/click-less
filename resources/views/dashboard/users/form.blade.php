<div class="row gy-3">
    <div class="col-lg-6">
        <x-dashboard.form.label for="name">{{__('dashboard.users_management.form.name')}}</x-admin.form.label>
    ...
    <div class="col-lg-6">
        <x-dashboard.form.label for="email">{{__('dashboard.users_management.form.email')}}</x-admin.form.label>
            <x-dashboard.form.input type="email" name="email" id="email"
                placeholder="{{__('dashboard.users_management.form.email')}}"
                value="{{ old('email', $user->email) }}" />
            <x-dashboard.form.error :messages="$errors->get('email')" />
    </div>

    <div class="col-lg-6">
        <x-dashboard.form.label for="password">{{__('dashboard.users_management.form.password')}}</x-admin.form.label>
    ...
    <div class="col-lg-6">
        <x-dashboard.form.label
            for="password_confirmation">{{__('dashboard.users_management.form.password_confirmation')}}</x-admin.form.label>
    ...
    <div class="col-lg-6">
        <x-dashboard.form.label for="role">{{__('dashboard.users_management.form.role')}}</x-admin.form.label>
    ...
    <div class="col-lg-6">
        <x-dashboard.form.label for="status">{{__('dashboard.users_management.form.status')}}</x-admin.form.label>
