<div class="row gy-3">
    ...
    <div class="col-lg-6">
        <x-form.label for="font_color">{{ __('dashboard.bank_management.form.font_color') }}</x-dashboard.form.label>
    ...
    <div class="col-lg-6">
        <x-form.label for="logo">{{ __('dashboard.bank_management.form.logo') }}</x-dashboard.form.label>
            ...
            @if ($bank->hasMedia('logo'))
                <div class="mt-2">
                    <img style="height: 50px;" src="{{ $bank->getFirstMediaUrlSafe('logo') }}"
                        alt="{{ $bank->title }}">
                </div>
            @endif
    </div>
    ...
    <div class="col-lg-6">
        <x-form.label for="image">{{ __('dashboard.bank_management.form.image') }}</x-dashboard.form.label>
    ...
    <div class="col-lg-6">
        <x-form.label for="status">{{ __('dashboard.bank_management.form.status') }}</x-dashboard.form.label>
    ...
    <div class="col-lg-6">
        <x-form.label for="ai_key">{{ __('dashboard.bank_management.form.ai_key') }}</x-dashboard.form.label>
