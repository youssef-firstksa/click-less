<div class="row gy-3">
    @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
        <div class="col-lg-6 mb-4">
            <x-dashboard.form.label for="title">{{__('dashboard.bank_management.form.title')}}
    ...
    @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
        <div class="col-lg-6">
            <x-dashboard.form.label for="description">{{__('dashboard.bank_management.form.description')}}
                ({{$properties['native']}})</x-dashboard.form.label>
