<div class="row gy-3">
                    ...
                    <div class="row">
                        <div class="col-12 mb-4">
                            <x-dashboard.form.label
                                for="title">{{__('dashboard.bank_management.form.title')}}</x-admin.form.label>
                        ...
                        <div class="col-12">
                            <x-dashboard.form.label
                                for="description">{{__('dashboard.bank_management.form.description')}}</x-admin.form.label>
                                <x-dashboard.form.textarea name="{{ $localeCode }}[description]"
                                    id="description_{{ $localeCode }}"
                                    placeholder="{{__('dashboard.bank_management.form.description')}}">{{ old($localeCode . '.description', $bank->{'description:' . $localeCode}) }}</x-admin.form.textarea>
    ...
    <div class="col-lg-6">
        <x-dashboard.form.label for="color">{{__('dashboard.bank_management.form.font_color')}}</x-admin.form.label>
    ...
    <div class="col-lg-6">
        <x-dashboard.form.label
            for="background_color">{{__('dashboard.bank_management.form.background_color')}}</x-admin.form.label>
    ...
    <div class="col-lg-6">
        <x-dashboard.form.label for="logo">{{__('dashboard.bank_management.form.logo')}}</x-admin.form.label>
    ...
    <div class="col-lg-6">
        <x-dashboard.form.label for="image">{{__('dashboard.bank_management.form.image')}}</x-admin.form.label>
    ...
    <div class="col-lg-6">
        <x-dashboard.form.label for="status">{{__('dashboard.bank_management.form.status')}}</x-admin.form.label>
    ...
    <div class="col-lg-6">
        <x-dashboard.form.label for="ai_key">{{__('dashboard.bank_management.form.ai_key')}}</x-admin.form.label>
            <x-dashboard.form.input name="ai_key" id="ai_key"
                placeholder="{{__('dashboard.bank_management.form.ai_key')}}"
