<div class="row gy-3">
    ...
    <div class="col-lg-6">
        <x-form.label for="bank_id">{{ __('dashboard.sections_management.form.bank') }}</x-form.label>
    ...
    <div class="col-lg-6">
        <x-form.label for="product_id">{{ __('dashboard.sections_management.form.product') }}</x-form.label>
    ...
    <div class="col-lg-6">
        <x-form.label for="status">{{ __('dashboard.sections_management.form.status') }}</x-form.label>
