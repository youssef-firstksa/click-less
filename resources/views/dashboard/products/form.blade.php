<div class="row gy-3">
    ...
    <div class="col-lg-6">
        <x-form.label for="status">{{ __('dashboard.products_management.form.status') }}</x-form.label>
    ...
    <div class="col-lg-6">
        <x-form.label for="bank_id">{{ __('dashboard.products_management.form.bank') }}</x-form.label>
