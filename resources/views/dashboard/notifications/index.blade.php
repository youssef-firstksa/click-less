<x-layouts.dashboard.master>
    ...
    <div class="card">
        ...
        <div class="card-body p-24">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    @if ($notification->status == App\Enums\Status::ACTIVATED)
                                        <x-dashboard.status status="success" :content="strtoupper(__('dashboard.general.' . $notification->status->value))" />
                                    @else
                                        <x-dashboard.status status="danger" :content="strtoupper(__('dashboard.general.' . $notification->status->value))" />
                                    @endif
                                </td>
            ...
            <x-dashboard.table.pagination :data="$notifications" class="mt-3" />
        </div>
    </div>
