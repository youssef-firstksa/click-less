<div class="row gy-3">
    ...
    <div class="col-lg-6">
        ...
        <x-dashboard.form.select2 id="notification_type" name="notification_type" :options="\App\Enums\NotificationType::labels()"
    ...
    <div class="col-lg-6">
        ...
        <x-dashboard.form.select2 id="notification_view" name="notification_view" :options="\App\Enums\NotificationView::labels()"
