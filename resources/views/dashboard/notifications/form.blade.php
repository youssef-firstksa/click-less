<div class="row gy-3">
    ...
    <div class="col-lg-6 mb-4">
        <x-form.label
            for="publish_start_at">{{ __('dashboard.notifications_management.form.publish_start_at') }}</x-form.label>
    ...
    <div class="col-lg-6 mb-4">
        <x-form.label
            for="publish_end_at">{{ __('dashboard.notifications_management.form.publish_end_at') }}</x-form.label>
    ...
    <div class="col-lg-6">
        <x-form.label for="bank_id">{{ __('dashboard.notifications_management.form.bank') }}</x-form.label>
    ...
    <div class="col-lg-6">
        <x-form.label for="status">{{ __('dashboard.notifications_management.form.status') }}</x-form.label>
