...
<head>
    ...
    @if (app()->getLocale() == 'ar')
        ...
        <link href="{{ asset('assets/admin/css/custom.rtl.css') }}" rel="stylesheet" type="text/css" />
    @endif
...
<body id="kt_body" class="app-blank bgi-size-cover bgi-attachment-fixed bgi-position-center">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <style>
            body {
                background-image: url("{{ asset('assets/admin/media/auth/bg10.jpg') }}");
            }
        </style>
        <!--end::Page bg image-->
        ...
        <div class="auth-lang">
            @if (app()->getLocale() == 'en')
                <a href="{{ LaravelLocalization::getLocalizedURL('ar', null, [], true) }}" class="btn btn-sm btn-danger">
                    AR
                </a>
            @else
                <a href="{{ LaravelLocalization::getLocalizedURL('en', null, [], true) }}" class="btn btn-sm btn-danger">
                    EN
                </a>
            @endif
        </div>
    ...
    <script src="{{ asset('assets/admin/js/custom/landing.js') }}"></script>
